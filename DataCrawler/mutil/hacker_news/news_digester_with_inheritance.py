...
class HNTopPostsSpider:
    ...
    def __init__(self, fp: TextIO, limit: int = 5) -> None:
        self.fp = fp
        self.limit = limit

    def write_to_file(self):
        """以存文本格式将 Hacker News Top 内容写入文件"""
...
def main():
    # with open('hn_top5.txt') as fp:
    #     crawler = HNTopPostsSpider(fp)
    #     crawler.write_to_file()

    # HNTopPostsSpider 接受任何 file-like 对象、可以把 sys.stdout 传进去
    # 实现向控制台标准输出打印的功能
